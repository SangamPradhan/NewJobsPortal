                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="section-title text-center">
                            <h2>Testimonials <small>from around the Nepal</small></h2>
                        </div>
                        ...
                        <div class="owl-carousel owl-theme owl-client">
                            <div class="col-md-4 col-sm-4">
                                <div class="item">
                                    <div class="tst-image">
                                        <img src="home/images/tst-image-1-200x216.jpg" class="img-responsive"
                                            alt="">
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="item">
                                    <div class="tst-image">
                                        <img src="home/images/tst-image-2-200x216.jpg" class="img-responsive"
                                            alt="">
                                    </div>
                                    <div class="tst-author">
                                        <h4>Camila</h4>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="item">
                                    <div class="tst-image">
                                        <img src="home/images/tst-image-3-200x216.jpg" class="img-responsive"
                                            alt="">
                                    </div>
                                    <div class="tst-author">
                                        <h4>Barbie</h4>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="item">
                                    <div class="tst-image">
                                        <img src="home/images/tst-image-4-200x216.jpg" class="img-responsive"
                                            alt="">
                                    </div>
                                    <div class="tst-author">
                                        <h4>Andrio</h4>
